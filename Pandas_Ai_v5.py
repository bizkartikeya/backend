...
class BankDataAnalysis:
    ...
    def process_keywords_and_print_dataframes(self, result_keyword):
        ...
        for df_name in result_keyword:
            ...
            if dataframe is not None:
                ...
                print("result - 1- if: ",result)
                print("result - 2",newResult)
            else:
                print(f"Dataframe {df_name} not found.")
            # dict_df=dataframe
            print("result - 1",result)
        print("result from function: ",newResult)
        return newResult
    ...
    def query_data(self, query_req: QueryRequest):
        ...
        code_df=self.dl.last_code_generated
        print("final",(code_df))

        result_keyword =self.check_keywords_occurrence(code_df, self.keywords)
        print("result_keyword found:  ",result_keyword)
        ...
        print("response_df value::",response_df)

        print("response_df",self.process_keywords_and_print_dataframes(result_keyword))
        response = {"result": result, "last_code_generated": self.dl.last_code_generated, "dataframe":response_df}
    ...
    def check_keywords_occurrence(self,result, keywords):
        ...
        print("multiple_occurrence_keywords found:::  ",multiple_occurrence_keywords)
